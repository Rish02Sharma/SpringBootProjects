...
import com.rishabh.springbootprojects.exception.RateLimitException;
...
public class RateLimitAspect {
    ...
    private final long rateDuration=6000;
    ...
    public void rateLimit() {
        ...
        System.out.println("Size of API rate" + requestCounts.get(key).size());
